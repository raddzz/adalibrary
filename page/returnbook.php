...
<head>
  ...
  <title>Ada Library - Return Book</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block active">
        <a href="/?page=lendbook" class="nav-link">Return Book</a>
      </li>
      <!-- SEARCH FORM -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="?page=returnbook" class="nav-link active">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card card-primary">
              <!-- form start -->
              <form role="form" action="forms/returnbook.php" method="post">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" value="Lend Book" class="btn btn-primary">Return Book</button>
                </div>
                <?php if (isset($_GET["callback"])) {
                  if ($_GET{"callback"} == "success") {
                    ?><div class="callout callout-success">
                  <h5>Book successfully returned!!</h5>

                  <p>Thank you.</p>
                </div><?php
                  }
                  elseif ($_GET["callback"] == "notlent") {
                    ?><div class="callout callout-danger">
                  <h5>Book not Lent out</h5>
