...
<head>
  ...
  <title>Ada Library - Manage Books</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block active">
        <a href="/>page=booklookup" class="nav-link">Manage Books</a>
      </li>
      <!-- SEARCH FORM -->
         ...
         <li class="nav-item">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="?page=books" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <table class="table table-bordered table-hover" id="books"><thead><tr><th>Title</th><th>Author</th><th>Thumbnail</th><th>ISBN</th><th>More Information</th></tr></thead><tbody>
            <?php
